...
public class TicTacToeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//Temporary, need to change this in 3rd assignment to automatically know the teacher based on user currently logged in
		if (action == null) {
			...
			writer.write("<a href='" + request.getContextPath() + MAIN_MENU_URL
	...
	public String writeTicTacToeGame() {
		String form = "<!doctype html><html><title>Tic Tac Toe!</title>" + "<body><h1>Placeholder for Tic Tac Toe game</h1>"
